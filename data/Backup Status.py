def start(n=''):
   ...
   conferidor = False
   while True:
      buscar_nome = driver.find_elements(By.XPATH, '//html/body/vex-root/vex-custom-layout/vex-layout/div/mat-sidenav-container/mat-sidenav-content/main/vex-search/div/div/vex-search-player/div/div/mat-card-content/div/div/div/h2')[cont].text
      for l in range(0, 101):
         if f'{n} ({l})' == buscar_nome:
            conferidor = True
      if conferidor == True:
         player = driver.find_elements(By.XPATH, '//html/body/vex-root/vex-custom-layout/vex-layout/div/mat-sidenav-container/mat-sidenav-content/main/vex-search/div/div/vex-search-player/div/div/mat-card-content/div/div/div/h2')[cont]
         player.click()
         break
      cont += 1
      if cont == 3:
